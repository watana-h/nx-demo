...
import { UserItem, ErrorTarget,
         AppendUserItemRequestBody,
         UpdateUserItemRequestBody } from '@nx-demo/api-interfaces';
...
export class UserEditComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    const ptnTelephone = "^[0-9-]+$";
    const ptnEmail = "^([a-zA-Z0-9])+([a-zA-Z0-9\._-])*@([a-zA-Z0-9_-])+([a-zA-Z0-9\._-]+)+$";
